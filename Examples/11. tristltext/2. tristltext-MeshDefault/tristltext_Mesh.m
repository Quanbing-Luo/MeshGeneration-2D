...
axis equal off
exportgraphics(gca,'tristltext-MeshDefault.pdf','ContentType','vector');
savefig(gcf,'tristltext-MeshDefault.fig','compact');
...
grid on
exportgraphics(gca,'tristltext-MeshQualityDefault.pdf','ContentType','vector');
savefig(gcf,'tristltext-MeshQualityDefault.fig','compact');
...
axis equal off
exportgraphics(gca,'tristltext-MeshRadiiDefault.pdf','ContentType','vector');
savefig(gcf,'tristltext-MeshRadiiDefault.fig','compact');