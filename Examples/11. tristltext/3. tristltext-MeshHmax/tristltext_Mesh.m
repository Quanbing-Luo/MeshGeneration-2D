...
clear;
meshgeneration('geometry.dat','meshradii.dat', Hmax = 0.4); 
...
axis equal off
exportgraphics(gca,'tristltext-MeshHmax.pdf','ContentType','vector');
savefig(gcf,'tristltext-MeshHmax.fig','compact');
...
grid on
exportgraphics(gca,'tristltext-MeshQualityHmax.pdf','ContentType','vector');
savefig(gcf,'tristltext-MeshQualityHmax.fig','compact');
...
axis equal off
exportgraphics(gca,'tristltext-MeshRadiiHmax.pdf','ContentType','vector');
savefig(gcf,'tristltext-MeshRadiiHmax.fig','compact');