...
axis equal off
exportgraphics(gca,'TwoHoles-MeshDefault.pdf','ContentType','vector');
savefig(gcf,'TwoHoles-MeshDefault.fig','compact');
...
grid on
exportgraphics(gca,'TwoHoles-MeshQualityDefault.pdf','ContentType','vector');
savefig(gcf,'TwoHoles-MeshQualityDefault.fig','compact');
...
axis equal off
exportgraphics(gca,'TwoHoles-MeshRadiiDefault.pdf','ContentType','vector');
savefig(gcf,'TwoHoles-MeshRadiiDefault.fig','compact');