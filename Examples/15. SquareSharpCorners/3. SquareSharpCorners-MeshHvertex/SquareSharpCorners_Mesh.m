...
clear;
meshgeneration('geometry.dat','meshradii.dat', Hvertex = {[1 4], 0.01}); 
...
axis equal off
exportgraphics(gca,'SquareSharpCorners-MeshHvertex.pdf','ContentType','vector');
savefig(gcf,'SquareSharpCorners-MeshHvertex.fig','compact');
...
grid on
exportgraphics(gca,'SquareSharpCorners-MeshQualityHvertex.pdf','ContentType','vector');
savefig(gcf,'SquareSharpCorners-MeshQualityHvertex.fig','compact');
...
axis equal off
exportgraphics(gca,'SquareSharpCorners-MeshRadiiHvertex.pdf','ContentType','vector');
savefig(gcf,'SquareSharpCorners-MeshRadiiHvertex.fig','compact');