...
axis equal off
exportgraphics(gca,'SquareSharpCorners-MeshDefault.pdf','ContentType','vector');
savefig(gcf,'SquareSharpCorners-MeshDefault.fig','compact');
...
grid on
exportgraphics(gca,'SquareSharpCorners-MeshQualityDefault.pdf','ContentType','vector');
savefig(gcf,'SquareSharpCorners-MeshQualityDefault.fig','compact');
...
axis equal off
exportgraphics(gca,'SquareSharpCorners-MeshRadiiDefault.pdf','ContentType','vector');
savefig(gcf,'SquareSharpCorners-MeshRadiiDefault.fig','compact');