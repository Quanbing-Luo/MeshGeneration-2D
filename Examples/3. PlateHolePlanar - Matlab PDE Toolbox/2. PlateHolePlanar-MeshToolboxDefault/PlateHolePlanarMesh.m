...
axis equal off
exportgraphics(gca,'PlateHolePlanar-MeshToolboxDefault.pdf','ContentType','vector');
savefig(gcf,'PlateHolePlanar-MeshToolboxDefault.fig','compact');
...
grid on
exportgraphics(gca,'PlateHolePlanar-MeshToolboxQualityDefault.pdf','ContentType','vector');
savefig(gcf,'PlateHolePlanar-MeshToolboxQualityDefault.fig','compact');