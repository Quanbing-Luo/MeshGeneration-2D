...
axis equal off
exportgraphics(gca,'PlateHolePlanar-MeshToolboxHgrad.pdf','ContentType','vector');
savefig(gcf,'PlateHolePlanar-MeshToolboxHgrad.fig','compact');
...
grid on
exportgraphics(gca,'PlateHolePlanar-MeshToolboxQualityHgrad.pdf','ContentType','vector');
savefig(gcf,'PlateHolePlanar-MeshToolboxQualityHgrad.fig','compact');