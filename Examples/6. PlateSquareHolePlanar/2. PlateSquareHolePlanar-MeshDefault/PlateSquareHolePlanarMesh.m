...
axis equal off
exportgraphics(gca,'PlateSquareHolePlanar-MeshDefault.pdf','ContentType','vector');
savefig(gcf,'PlateSquareHolePlanar-MeshDefault.fig','compact');
...
grid on
exportgraphics(gca,'PlateSquareHolePlanar-MeshQualityDefault.pdf','ContentType','vector');
savefig(gcf,'PlateSquareHolePlanar-MeshQualityDefault.fig','compact');
...
axis equal off
exportgraphics(gca,'PlateSquareHolePlanar-MeshRadiiDefault.pdf','ContentType','vector');
savefig(gcf,'PlateSquareHolePlanar-MeshRadiiDefault.fig','compact');