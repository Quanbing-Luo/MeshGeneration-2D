...
clear;
meshgeneration('geometry.dat','meshradii.dat', Hgrad = 1.2); 
...
axis equal off
exportgraphics(gca,'ArbitraryRegion-MeshHgrad.pdf','ContentType','vector');
savefig(gcf,'ArbitraryRegion-MeshHgrad.fig','compact');
...
grid on
exportgraphics(gca,'ArbitraryRegion-MeshQualityHgrad.pdf','ContentType','vector');
savefig(gcf,'ArbitraryRegion-MeshQualityHgrad.fig','compact');
...
axis equal off
exportgraphics(gca,'ArbitraryRegion-MeshRadiiHgrad.pdf','ContentType','vector');
savefig(gcf,'ArbitraryRegion-MeshRadiiHgrad.fig','compact');