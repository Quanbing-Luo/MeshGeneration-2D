...
axis equal off
exportgraphics(gca,'ArbitraryRegion-MeshDefault.pdf','ContentType','vector');
savefig(gcf,'ArbitraryRegion-MeshDefault.fig','compact');
...
grid on
exportgraphics(gca,'ArbitraryRegion-MeshQualityDefault.pdf','ContentType','vector');
savefig(gcf,'ArbitraryRegion-MeshQualityDefault.fig','compact');
...
axis equal off
exportgraphics(gca,'ArbitraryRegion-MeshRadiiDefault.pdf','ContentType','vector');
savefig(gcf,'ArbitraryRegion-MeshRadiiDefault.fig','compact');