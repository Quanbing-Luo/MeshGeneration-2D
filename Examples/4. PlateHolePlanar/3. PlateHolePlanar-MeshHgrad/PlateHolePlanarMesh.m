...
clear;
meshgeneration('geometry.dat','meshradii.dat', Hgrad=2); 
...
savefig(gcf,'PlateHolePlanar-MeshHgrad.fig','compact');
...
grid on
exportgraphics(gca,'PlateHolePlanar-MeshQualityHgrad.pdf','ContentType','vector');
savefig(gcf,'PlateHolePlanar-MeshQualityHgrad.fig','compact');
...
axis equal off
exportgraphics(gca,'PlateHolePlanar-MeshRadiiHgrad.pdf','ContentType','vector');
savefig(gcf,'PlateHolePlanar-MeshRadiiHgrad.fig','compact');