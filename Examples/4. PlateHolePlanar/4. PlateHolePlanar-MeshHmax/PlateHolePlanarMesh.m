...
clear;
meshgeneration('geometry.dat','meshradii.dat', Hmax=0.7); 
...
axis equal off
exportgraphics(gca,'PlateHolePlanar-MeshHmax.pdf','ContentType','vector');
savefig(gcf,'PlateHolePlanar-MeshHmax.fig','compact');
...
grid on
exportgraphics(gca,'PlateHolePlanar-MeshQualityHmax.pdf','ContentType','vector');
savefig(gcf,'PlateHolePlanar-MeshQualityHmax.fig','compact');
...
axis equal off
exportgraphics(gca,'PlateHolePlanar-MeshRadiiHmax.pdf','ContentType','vector');
savefig(gcf,'PlateHolePlanar-MeshRadiiHmax.fig','compact');