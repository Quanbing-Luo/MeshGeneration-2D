...
savefig(gcf,'PlateHolePlanar-MeshDefault.fig','compact');
...
grid on
exportgraphics(gca,'PlateHolePlanar-MeshQualityDefault.pdf','ContentType','vector');
savefig(gcf,'PlateHolePlanar-MeshQualityDefault.fig','compact');
...
axis equal off
exportgraphics(gca,'PlateHolePlanar-MeshRadiiDefault.pdf','ContentType','vector');
savefig(gcf,'PlateHolePlanar-MeshRadiiDefault.fig','compact');