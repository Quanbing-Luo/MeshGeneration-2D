...
axis equal off
exportgraphics(gca,'CircularDisk-MeshDefault.pdf','ContentType','vector');
savefig(gcf,'CircularDisk-MeshDefault.fig','compact');
...
grid on
exportgraphics(gca,'CircularDisk-MeshQualityDefault.pdf','ContentType','vector');
savefig(gcf,'CircularDisk-MeshQualityDefault.fig','compact');
...
axis equal off
exportgraphics(gca,'CircularDisk-MeshRadiiDefault.pdf','ContentType','vector');
savefig(gcf,'CircularDisk-MeshRadiiDefault.fig','compact');