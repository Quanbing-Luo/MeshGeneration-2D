...
% savefig(gcf,'SquareLargeHole-MeshDefault.fig','compact');
...
% savefig(gcf,'SquareLargeHole-MeshQualityDefault.fig','compact');
...
% savefig(gcf,'SquareLargeHole-MeshRadiiDefault.fig','compact');