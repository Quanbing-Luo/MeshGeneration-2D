...
savefig(gcf,'SquareLargeHole-MeshHmax.fig','compact');
...
savefig(gcf,'SquareLargeHole-MeshQualityHmax.fig','compact');
...
savefig(gcf,'SquareLargeHole-MeshRadiiHmax.fig','compact');