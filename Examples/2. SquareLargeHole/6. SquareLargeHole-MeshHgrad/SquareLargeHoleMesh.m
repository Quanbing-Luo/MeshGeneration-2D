...
savefig(gcf,'SquareLargeHole-MeshHgrad.fig','compact');
...
savefig(gcf,'SquareLargeHole-MeshQualityHgrad.fig','compact');
...
savefig(gcf,'SquareLargeHole-MeshRadiiHgrad.fig','compact');