...
savefig(gcf,'SquareLargeHole-MeshHvertex.fig','compact');
...
savefig(gcf,'SquareLargeHole-MeshQualityHvertex.fig','compact');
...
savefig(gcf,'SquareLargeHole-MeshRadiiHvertex.fig','compact');