...
savefig(gcf,'SquareLargeHole-MeshHedge.fig','compact');
...
savefig(gcf,'SquareLargeHole-MeshQualityHedge.fig','compact');
...
savefig(gcf,'SquareLargeHole-MeshRadiiHedge.fig','compact');