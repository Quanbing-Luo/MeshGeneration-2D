...
axis equal off
exportgraphics(gca,'WestVirginia-MeshDefault.pdf','ContentType','vector');
savefig(gcf,'WestVirginia-MeshDefault.fig');
...
grid on
exportgraphics(gca,'WestVirginia-MeshQualityDefault.pdf','ContentType','vector');
savefig(gcf,'WestVirginia-MeshQualityDefault.fig');
...
axis equal off
exportgraphics(gca,'WestVirginia-MeshRadiiDefault.pdf','ContentType','vector');
savefig(gcf,'WestVirginia-MeshRadiiDefault.fig');