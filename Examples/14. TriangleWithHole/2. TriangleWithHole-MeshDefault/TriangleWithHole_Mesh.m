...
axis equal off
exportgraphics(gca,'TriangleWithHole-MeshDefault.pdf','ContentType','vector');
savefig(gcf,'TriangleWithHole-MeshDefault.fig','compact');
...
grid on
exportgraphics(gca,'TriangleWithHole-MeshQualityDefault.pdf','ContentType','vector');
savefig(gcf,'TriangleWithHole-MeshQualityDefault.fig','compact');
...
axis equal off
exportgraphics(gca,'TriangleWithHole-MeshRadiiDefault.pdf','ContentType','vector');
savefig(gcf,'TriangleWithHole-MeshRadiiDefault.fig','compact');