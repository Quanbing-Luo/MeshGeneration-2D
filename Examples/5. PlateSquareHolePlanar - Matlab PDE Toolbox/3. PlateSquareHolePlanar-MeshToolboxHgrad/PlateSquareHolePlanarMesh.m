...
axis equal off
exportgraphics(gca,'PlateSquareHolePlanar-MeshToolboxHgrad.pdf','ContentType','vector');
savefig(gcf,'PlateSquareHolePlanar-MeshToolboxHgrad.fig','compact');
...
grid on
exportgraphics(gca,'PlateSquareHolePlanar-MeshToolboxQualityHgrad.pdf','ContentType','vector');
savefig(gcf,'PlateSquareHolePlanar-MeshToolboxQualityHgrad.fig','compact');