...
axis equal off
exportgraphics(gca,'PlateSquareHolePlanar-MeshToolboxDefault.pdf','ContentType','vector');
savefig(gcf,'PlateSquareHolePlanar-MeshToolboxDefault.fig','compact');
...
grid on
exportgraphics(gca,'PlateSquareHolePlanar-MeshToolboxQualityDefault.pdf','ContentType','vector');
savefig(gcf,'PlateSquareHolePlanar-MeshToolboxQualityDefault.fig','compact');