...
savefig(gcf,'FourHoles-MeshDefault.fig','compact');
...
grid on
exportgraphics(gca,'FourHoles-MeshQualityDefault.pdf','ContentType','vector');
savefig(gcf,'FourHoles-MeshQualityDefault.fig','compact');
...
axis equal off
exportgraphics(gca,'FourHoles-MeshRadiiDefault.pdf','ContentType','vector');
savefig(gcf,'FourHoles-MeshRadiiDefault.fig','compact');