...
savefig(gcf,'FourHoles-MeshHgrad.fig','compact');
...
grid on
exportgraphics(gca,'FourHoles-MeshQualityHgrad.pdf','ContentType','vector');
savefig(gcf,'FourHoles-MeshQualityHgrad.fig','compact');
...
axis equal off
exportgraphics(gca,'FourHoles-MeshRadiiHgrad.pdf','ContentType','vector');
savefig(gcf,'FourHoles-MeshRadiiHgrad.fig','compact');