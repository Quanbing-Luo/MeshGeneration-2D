...
savefig(gcf,'FourHoles-MeshHmax.fig','compact');
...
grid on
exportgraphics(gca,'FourHoles-MeshQualityHmax.pdf','ContentType','vector');
savefig(gcf,'FourHoles-MeshQualityHmax.fig','compact');
...
axis equal off
exportgraphics(gca,'FourHoles-MeshRadiiHmax.pdf','ContentType','vector');
savefig(gcf,'FourHoles-MeshRadiiHmax.fig','compact');