...
axis equal off
exportgraphics(gca,'SquareWithHole-MeshDefault.pdf','ContentType','vector');
savefig(gcf,'SquareWithHole-MeshDefault.fig','compact');
...
grid on
exportgraphics(gca,'SquareWithHole-MeshQualityDefault.pdf','ContentType','vector');
savefig(gcf,'SquareWithHole-MeshQualityDefault.fig','compact');
...
axis equal off
exportgraphics(gca,'SquareWithHole-MeshRadiiDefault.pdf','ContentType','vector');
savefig(gcf,'SquareWithHole-MeshRadiiDefault.fig','compact');