...
axis equal off
exportgraphics(gca,'Tennessee-MeshDefault.pdf','ContentType','vector');
savefig(gcf,'Tennessee-MeshDefault.fig');
...
grid on
exportgraphics(gca,'Tennessee-MeshQualityDefault.pdf','ContentType','vector');
savefig(gcf,'Tennessee-MeshQualityDefault.fig');
...
axis equal off
exportgraphics(gca,'Tennessee-MeshRadiiDefault.pdf','ContentType','vector');
savefig(gcf,'Tennessee-MeshRadiiDefault.fig');