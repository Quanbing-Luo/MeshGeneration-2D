...
savefig(gcf,'SquareInteriorNodes-MeshHvertex.fig','compact');
...
grid on
exportgraphics(gca,'SquareInteriorNodes-MeshQualityHvertex.pdf','ContentType','vector');
savefig(gcf,'SquareInteriorNodes-MeshQualityHvertex.fig','compact');
...
axis equal off
exportgraphics(gca,'SquareInteriorNodes-MeshRadiiHvertex.pdf','ContentType','vector');
savefig(gcf,'SquareInteriorNodes-MeshRadiiHvertex.fig','compact');