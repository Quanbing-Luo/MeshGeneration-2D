...
savefig(gcf,'SquareInteriorNodes-MeshHedge.fig','compact');
...
grid on
exportgraphics(gca,'SquareInteriorNodes-MeshQualityHedge.pdf','ContentType','vector');
savefig(gcf,'SquareInteriorNodes-MeshQualityHedge.fig','compact');
...
axis equal off
exportgraphics(gca,'SquareInteriorNodes-MeshRadiiHedge.pdf','ContentType','vector');
savefig(gcf,'SquareInteriorNodes-MeshRadiiHedge.fig','compact');