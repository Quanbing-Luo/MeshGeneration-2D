...
savefig(gcf,'SquareInteriorNodes-MeshDefault.fig','compact');
...
grid on
exportgraphics(gca,'SquareInteriorNodes-MeshQualityDefault.pdf','ContentType','vector');
savefig(gcf,'SquareInteriorNodes-MeshQualityDefault.fig','compact');
...
axis equal off
exportgraphics(gca,'SquareInteriorNodes-MeshRadiiDefault.pdf','ContentType','vector');
savefig(gcf,'SquareInteriorNodes-MeshRadiiDefault.fig','compact');