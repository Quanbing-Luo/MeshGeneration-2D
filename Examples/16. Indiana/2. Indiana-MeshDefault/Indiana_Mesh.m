...
axis equal off
exportgraphics(gca,'Indiana-MeshDefault.pdf','ContentType','vector');
savefig(gcf,'Indiana-MeshDefault.fig');
...
grid on
exportgraphics(gca,'Indiana-MeshQualityDefault.pdf','ContentType','vector');
savefig(gcf,'Indiana-MeshQualityDefault.fig');
...
axis equal off
exportgraphics(gca,'Indiana-MeshRadiiDefault.pdf','ContentType','vector');
savefig(gcf,'Indiana-MeshRadiiDefault.fig');