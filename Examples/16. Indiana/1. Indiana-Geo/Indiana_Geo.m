...
load usastates.mat
lat = usastates(12).Lat(1:end-2);
lon = usastates(12).Lon(1:end-2);
...
exportgraphics(gca,'Indiana-Geo.pdf','ContentType','vector');
savefig(gcf,'Indiana-Geo.fig');
